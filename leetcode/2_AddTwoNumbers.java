...
class AddTwoNumbers {
    ...
    /*
     * The simple solution is to create a new inked list to store the calculation result.
     * In this way, you just need to calculate the sum of corresponding digits in the different list, don't forget to add the carry.
     * To avoid the null pointers, it should make sure which list is not empty and get its value.
     */
    ...
    /*
     * Compare to the above solution, this way can save the memory, because it reuse the memory of l1 and l2.
     * You just need to put the calculation result to the l1. 
     * 
     * If the l2 is longer, you should to mark the end node of l1, and use it to connect with l2 has not been yet calculated.
     */
